	...
	jQuery.fn.extend({
		...
		toggleHighlight: function()
		{
			return this.each(function(){
				...
				object.toggleClass(object.hasClass('row') ? 'highlight_row' : 'highlight_row_odd');
			});
		},
		...
		setTopCheckbox: function()
		{
			return this.each(function(){
				...
				object.find("input[type='checkbox'][id^='id_admin_forms_all_check']").attr('checked', bChecked);
			});
		}
	});
